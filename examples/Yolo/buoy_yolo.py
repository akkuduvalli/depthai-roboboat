...
nnPath = str((Path(__file__).parent / Path('../models/buoy-model2/best_openvino_2022.1_6shave.blob')).resolve().absolute())
# nnPath = str((Path(__file__).parent / Path('../models/buoy-yolov8-model/best-next_openvino_2022.1_6shave.blob')).resolve().absolute())
print("Using yolov8 custom trained model")
...
detectionNetwork.setAnchorMasks({"side26": [1, 2, 3], "side13": [3, 4, 5],"side52":[6, 7, 8]})
